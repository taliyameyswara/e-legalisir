...
class TransactionController extends Controller
{
    public function index()
    {
        ...
        return view('superadmin.transaksi.index', compact('transactions'));
    }

    public function detail($id)
    {
        $transaction = Transaction::findOrFail($id);
        return view('superadmin.transaksi.detail', compact('transaction'));
    }
    public function acc($id)
    {
        ...
        return redirect()->route('superadmin.transaksi.index')->with('success', 'Transaksi berhasil acc');
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        return redirect()->route('superadmin.transaksi.index')->with('success', 'Transaksi berhasil disetujui dengan nomor pengiriman: ' . $request->nomor_pengiriman);
    }
    ...
    {
        return Excel::download(new TransactionExports, 'rekap-pengajuan.xlsx');
    }
}
